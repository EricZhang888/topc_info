...
<meta name=\"generator\" content=\"{$_M[config][metcms_v]}\"  data-variable=\"{$_M[config][met_weburl]}|{$_M[lang]}|{$classnow}|{$id}|{$class_list[$classnow][module]}|{$_M[config][met_skin_user]}|mobile\" />
...
<meta http-equiv=\"X-UA-Compatible\" content=\"IE=edge,chrome=1\">
<meta content=\"width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=0\" name=\"viewport\" />
<meta name=\"generator\" content=\"{$_M[config][metcms_v]}\"  data-variable=\"{$_M[config][met_weburl]},{$_M[lang]},{$classnow},{$id},{$class_list[$classnow][module]},{$_M[config][met_skin_user]}\" />
